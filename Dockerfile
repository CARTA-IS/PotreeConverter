...
# copy binary
COPY --from=build /data/build/PotreeConverter /data/build/PotreeConverter/PotreeConverter

# copy page template
COPY --from=build /data/build/resources /data/build/PotreeConverter/resources
